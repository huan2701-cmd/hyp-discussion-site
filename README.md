...
陈老师好。上次会议梳理出的 15 个问题已经做成了这个讨论页:

**https://huan2701-cmd.github.io/hyp-discussion-site/**

- 问题按 5 个主题分类;**Q4(用什么指标量化结构差异)和 Q12(如何验证分数与功能相关)是最高优先级**,其余问题都依赖这两个答案。
- 您点开任意问题,在页面下方用 GitHub 账号直接留言即可;每条评论会自动落在本仓库的 GitHub Discussion 里,方便后续逐条追溯、回复、跟进。
- 页面最下方有全部 Discussions 的汇总入口。
